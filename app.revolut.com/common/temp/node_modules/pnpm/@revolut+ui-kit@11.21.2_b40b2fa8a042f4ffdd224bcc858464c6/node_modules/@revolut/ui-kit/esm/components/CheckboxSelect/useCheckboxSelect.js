...
import { useCheckboxGroup, useControlled } from "../../hooks";
export function useCheckboxSelect(_ref) {
  ...
  var _useCheckboxGroup = useCheckboxGroup({
    ...
    shouldPassEvent: false
      ...
      internalValue = _useCheckboxGroup[0],
      getProps = _useCheckboxGroup[1],
      internalUpdate = _useCheckboxGroup[2];
