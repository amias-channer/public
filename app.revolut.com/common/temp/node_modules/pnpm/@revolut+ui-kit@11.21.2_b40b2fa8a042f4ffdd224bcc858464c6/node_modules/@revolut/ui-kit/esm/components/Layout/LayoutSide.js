...
export var LayoutSideBase = /*#__PURE__*/styled(Box).withConfig({
  displayName: "LayoutSide__LayoutSideBase",
  componentId: "sc-1halyzr-0"
})(css({
  gridArea: Area.SIDE,
  position: ['fixed', null, null, 'sticky'],
  top: 0,
  left: 0,
  zIndex: Z_INDICES.SIDE,
  width: ['100%', null, null, 'auto'],
  height: [null, null, null, '100vh']
}));
export function LayoutSide(_ref) {
  var children = _ref.children,
      rest = _objectWithoutPropertiesLoose(_ref, ["children"]);

  return /*#__PURE__*/React.createElement(LayoutSideBase, _extends({
    use: "aside"
