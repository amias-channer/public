...
/** @private */
export var LineClampBase = /*#__PURE__*/styled.span.withConfig({
  displayName: "LineClamp__LineClampBase",
  componentId: "sc-1asyw6f-0"
})(lineClamp);

function LineClampTooltip(_ref) {
  ...
  useSizeOnMouseEnter(ref, tooltip === 'auto', function (outerRect, innerRect) {
    setHidden(outerRect.height < innerRect.height);
  ...
  }, /*#__PURE__*/React.createElement(LineClampBase, _extends({
    ref: ref
  }, rest), children));
}

export function LineClamp(_ref2) {
  ...
  if (tooltip === 'always' || tooltip === 'auto') {
    return /*#__PURE__*/React.createElement(LineClampTooltip, _extends({
      tooltip: tooltip
    }, rest), children);
  }

  return /*#__PURE__*/React.createElement(LineClampBase, rest, children);
}