...
export function useDropdownCell() {
  ...
  var getDropdownProps = useCallback(function (props) {
    return _extends({
      ...
      }, props == null ? void 0 : props.onClickAway),
      onClick: combine(props == null ? void 0 : props.onClick, function (event) {
  ...
  var getSelectProps = useCallback(function (props) {
    return _extends({
      ...
      onRequestClose: combine(function () {
        return setOpen(false);
      }, props == null ? void 0 : props.onRequestClose),
      onClick: combine(props == null ? void 0 : props.onClick, function (event) {
        return event.stopPropagation();
      })
    });
