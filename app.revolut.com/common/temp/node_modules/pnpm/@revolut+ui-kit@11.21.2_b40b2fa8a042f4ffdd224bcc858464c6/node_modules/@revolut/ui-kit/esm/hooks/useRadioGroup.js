...
export var useRadioGroup = function useRadioGroup(_ref) {
  ...
  var getProps = useCallback(function (_ref2) {
    ...
    var isChecked = value === inputValue;
    ...
    var handleChange = function handleChange(event) {
      ...
      if (shouldPassEvent) {
        setValue(isChecked ? null : inputValue, event);
      } else {
        setValue(isChecked ? null : inputValue);
      }
    };
  ...
  }, [value, isDisabled, setValue, shouldPassEvent]);
