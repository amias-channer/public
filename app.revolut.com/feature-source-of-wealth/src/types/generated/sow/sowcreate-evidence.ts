...
import { SOWEvidenceSubTypeType } from './sowevidence-sub-type-type'
import { SOWEvidenceTypeType } from './sowevidence-type-type'
import { SOWExternalRef } from './sowexternal-ref'
import { SOWIncomeDestinationType } from './sowincome-destination-type'

/**
 * `incomeDestination` should be `REVOLUT` if money was paid directly to revolut account, othrwise `EXTERNAL`
 * @export
 * @interface SOWCreateEvidence
 */
export interface SOWCreateEvidence {
  /**
   *
   * @type {SOWEvidenceTypeType}
   * @memberof SOWCreateEvidence
   */
  incomeSource: SOWEvidenceTypeType
  /**
   *
   * @type {SOWIncomeDestinationType}
   * @memberof SOWCreateEvidence
   */
   ...
   * @memberof SOWCreateEvidence
   */
  alertId?: SOWExternalRef
  /**
   * Minor amount of money, if user specifies 10$ then send 1000, not 10, if user specifies 10,56$ then send 1056
   * @type {number}
   * @memberof SOWCreateEvidence
   */
  minorAmount: number
   ...
   * @memberof SOWCreateEvidence
   */
  currency: SOWCreateEvidenceCurrencyEnum
  /**
   *
   * @type {SOWEvidenceSubTypeType}
   * @memberof SOWCreateEvidence
   */
  incomeFrequency: SOWEvidenceSubTypeType
  /**
   *
   * @type {string}
   * @memberof SOWCreateEvidence
  ...
  /**
   * Id of ActionToDo that is used during reask/request of an evidence
   * @type {string}
   * @memberof SOWCreateEvidence
   */
  actionToDoId?: string | null
}
 ...
 * @enum {string}
 */
export enum SOWCreateEvidenceCurrencyEnum {
  GBP = 'GBP',
  PLN = 'PLN',
  EUR = 'EUR',
  USD = 'USD',
