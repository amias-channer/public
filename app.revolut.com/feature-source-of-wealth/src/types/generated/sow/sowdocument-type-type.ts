 ...
 * @enum {string}
 */
export enum SOWDocumentTypeType {
  Last3Payslips = 'LAST_3_PAYSLIPS',
  BankStatement = 'BANK_STATEMENT',
  ProofOfIncome = 'PROOF_OF_INCOME',
  GenericProofOfIncome = 'GENERIC_PROOF_OF_INCOME',
  RentalAgreement = 'RENTAL_AGREEMENT',
  TaxReturn = 'TAX_RETURN',
  ProofOfSavings = 'PROOF_OF_SAVINGS',
  ProofOfInvestment = 'PROOF_OF_INVESTMENT',
  CryptoProofOfInvestment = 'CRYPTO_PROOF_OF_INVESTMENT',
  ProofOfSale = 'PROOF_OF_SALE',
  LoanAgreement = 'LOAN_AGREEMENT',
  ProofOfDivorceSettlement = 'PROOF_OF_DIVORCE_SETTLEMENT',
  ProofOfWinnings = 'PROOF_OF_WINNINGS',
  DividendVoucher = 'DIVIDEND_VOUCHER',
  SupportingPartyIncome = 'SUPPORTING_PARTY_INCOME',
  GrantOfProbate = 'GRANT_OF_PROBATE',
