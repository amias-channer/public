...
export type AssetSearch_data = {
    ...
    readonly " $fragmentRefs": FragmentRefs<"CollectionHeadMetadata_data" | "AssetSearchFilter_data" | "SearchPills_data">;
    readonly " $refType": "AssetSearch_data";
};
export type AssetSearch_data$data = AssetSearch_data;
export type AssetSearch_data$key = {
    readonly " $data"?: AssetSearch_data$data;
...
(node as any).hash = '35e328edd9e42614a5f4edf300e45720';
export default node;
