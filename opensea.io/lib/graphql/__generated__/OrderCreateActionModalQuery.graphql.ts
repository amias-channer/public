...
export type OrderCreateActionModalQueryVariables = {
    ...
    useMetaTransactions?: boolean | null;
...
query OrderCreateActionModalQuery(
  ...
  blockchain {
    orderCreateActions(maker: $maker, makerAssets: $makerAssetQuantities, takerAssets: $takerAssetQuantities, expiration: $expiration, useMetaTransactions: $useMetaTransactions, openedAt: $openedAt) {
...
return {
  ...
  "params": {
    "cacheID": "04b894c14b17472a936dd71afe6dc7ba",
    "id": null,
    "metadata": {},
    "name": "OrderCreateActionModalQuery",
    "operationKind": "query",
...
(node as any).hash = '72967c353b035301934c6009443a730a';
export default node;
