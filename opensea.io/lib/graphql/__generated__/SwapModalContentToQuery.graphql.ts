...
export type SwapModalContentToQuery = {
    readonly response: SwapModalContentToQueryResponse;
    readonly variables: SwapModalContentToQueryVariables;
};
...
return {
  ...
  "params": {
    "cacheID": "093452ddb0f4df33240b690a6d6c2dd2",
    "id": null,
    "metadata": {},
    "name": "SwapModalContentToQuery",
    "operationKind": "query",
    "text": "query SwapModalContentToQuery(\n  $address: AddressScalar!\n  $symbol: String!\n  $chain: ChainScalar!\n) {\n  paymentAsset(symbol: $symbol, chain: $chain) {\n    asset {\n      relayId\n      decimals\n      id\n    }\n    id\n  }\n  wallet(address: $address) {\n    fundsOf(symbol: $symbol, chain: $chain) {\n      name\n      symbol\n      chain\n      quantity\n      image\n      usdPrice\n      supportedSwaps {\n        symbol\n        chain {\n          identifier\n          id\n        }\n        id\n      }\n    }\n  }\n}\n"
  }
};
})();
(node as any).hash = '24d920b957d50d1aeda414962df7b543';
export default node;
