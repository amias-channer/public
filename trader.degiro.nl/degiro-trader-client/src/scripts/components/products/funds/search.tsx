...
import {FundsSearchRequestParams} from 'frontend-core/dist/services/products/fund/get-funds-search-request-params-from-filter-values';
...
export interface FundsSearchProps {
    searchParams: FundsSearchRequestParams;
    onData?: (data: ProductInfo[]) => void;
}

const {useState} = React;
const FundsSearch: React.FunctionComponent<FundsSearchProps> = ({searchParams}) => {
...
export default React.memo(FundsSearch);
